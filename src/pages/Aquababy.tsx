...
export default function AquaBaby() {
  ...
  return <div className="AquaBabyPage pt-[84px] pb-20 text-[18px]">
    ...
    <div className="content flex flex-col gap-12 mt-10 pl-10 pr-10 ">
      ...
      <div>
        <h3 className="mb-6 text-[24px] underline font-bold font-[Playfair-Display]">Overview:</h3>
        <div className="flex flex-col gap-4">
          <p>Becoming an Aqua Baby is a magical journey. From wetting baby’s head, to safety skills and confident underwater swimming, we build on baby’s confidence through gentle progression on our structured courses. We teach parents to coach their infants in the water. We use songs and games to teach specific safety skills.</p>
          <p>
      ...
      <div>
        <h3 className="mb-6 text-[24px] underline font-bold font-[Playfair-Display]">Common Questions:</h3>
        <ul className="list-decimal flex flex-col gap-4 pl-4">
          <li className="font-bold">What do I need to take to the class?
            <ul className="font-normal list-disc flex items-start  gap-4 pl-4">
              <div className="flex flex-col items-start basis-[65vw]">
                <li>Nappy bag, clean nappy & creams etc. Some Mums like to take a changing mat too.</li>
                <li>A snack (or warm bottle if you are bottle-feeding) for after the swim.</li>
                <li>A towel, preferably one with a hood or a toweling dressing gown</li>
              </div>
              <div className="flex flex-col items-start">
                <li>Happy Nappy</li>
                <li>Auqa Nappy</li>
                <li>Swim Cap, Swimwear & towel</li>
              </div>
            </ul>
          </li>
          <li className="font-bold">When can I start swimming with my baby?</li>
          <p>We advise mothers to consult a health professional for advice. children over 3 months can start in 30 degree pools.</p>
          <li className="font-bold">Will my child be able to swim?</li>
          <p>Children under three years old lack the muscle power, co-ordination and the motor-skills to hold their head above the water surface and breathe, therefore, they are too young to learn the more structured swimming and breathing techniques required to master swimming strokes. whoever we have many kids who start to float and swim by themselves at age 22 months.</p>
          <li className="font-bold">Do I need to be able to swim?</li>
          <p>No need to be able to swim, the pools are all within your depth and your feet will be firmly on the floor.</p>
        </ul>
      </div>
      <div>
        <h3 className="mb-6 text-[24px] underline font-bold font-[Playfair-Display]">Class Ettiquette:</h3>
        <ul className="list-disc flex flex-col gap-4 pl-4">
          <li>Arrive 10 mins earlier to the scheduled lesson time. That way You will have enough time to get ready and prepare yourself to join the class. Aqua baby classes are usually group classes, so we need to respect everyone’s time.</li>

          <li>Make sure your baby is wearing swim diapers to maintain the pool’s hygiene and to ensure his comfort. Babies will surely not enjoy the experience if they are waterlogged in their normal diapers. He/she must be wearing a swimsuit as well</li>

          <li>Make sure you have everything you need in your bag before leaving the house. You will need to have normal diapers, wet wipes, towels for you and your baby, dry clothes, snacks, drinks or milk bottle.</li>

          <li>It is better to plan your day. It is better to take your baby swimming when they’re fed, rested and not unwell.</li>

          <li>We have a lot of fun, colorful, safe and interactive toys available in our classes. Do not hesitate to get your child’s favorite bath toy.</li>
        </ul>
      </div>
    </div>
  </div >
