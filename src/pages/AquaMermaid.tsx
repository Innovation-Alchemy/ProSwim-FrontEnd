    ...
    <div className="content flex flex-col gap-2 mt-10 pl-10 pr-10 ">
      ...
      <div className="flex flex-col gap-8 mb-16">
        <div className="flex flex-col gap-2">
          <p className="font-bold">Aqua-Mermaid class (6 years+) is an artistic experience to keep fit and have fun…at the same time..!!</p>
          <p>
            Yes, dreams do come true. and Mermaids are real.! Aqua mermaid class is a new sport where you can transform into distinguished mermaids. You will learn how to swim with a mermaid tail using both legs while getting a great core workout. Before you can glide through the water, you will learn monofin and synchronized swimming techniques.
          </p>
          <p>
            Mermaid class is exactly what it sounds like! You put on a tail and learn how to twist, spin, and splash like a mermaid! So, what exactly do mermaid lessons entail? Just like swimming, mermaid classes have a series of levels that you can work your way up. Beginners will learn the basics, like putting on a mermaid tail, safety, and care, and how to enter and exit the pool.</p>
          <p>
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <ul className="list-disc flex flex-col gap-1 pl-4">
            ...
            <li>Return the mermaid tail and Monofin at the end of the class.</li>
            <li>Communicate with your instructor...Let your instructor know if you are uncomfortable, not feeling well or if there is anything bothering you…</li>
            <li>In case you want to take pictures, book a photoshoot session at our front desk upon arrival…</li>
          </ul>
        </div>
      </div>
