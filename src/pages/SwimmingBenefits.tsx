...
export default function SwimmingBenefits() {
  ...
  return <div className="SwimmingBenefitsPage pt-[84px] pb-20">
    ...
    <div className="content flex flex-col mt-10 pl-10 pr-10">
      ...
      <p className="mb-6 text-[16px]">Do you know why swimming is the best sport for you from health perspective? Well, because it has lots of health benefits, physically and mentally, in addition to the important values that can change your life in a positive way.!</p>
      <ul className="list-decimal flex flex-col gap-12 pl-4 text-[16px]">
        <li className="font-bold font-[Playfair-Display]">Benefits on physical health:
          <ul className="mt-2 list-disc font-normal flex flex-col gap-1 pl-4 text-[16px]">
