    ...
    <div className='FooterPage'>
      ...
      <div className="content">
        ...
        <div className="upperBox flex items-start justify-around font-[Playfair-Display]">
          <div className='upperPart basis-1/10'>
            <h1 className='block relative group text-nowrap px-4 py-2 pt-0 cursor-pointer text-white hover:text-white'>Links</h1>
            <div className="Inner__upperPart text-left h-full flex flex-col items-start justify-between ">
              <NavLink
                to='/'
          ...
          <div className='upperPart basis-1/3'>
            <h1 className='leading-[26px] mb-6'>Support Center (8:00AM till 8:00PM)</h1>
            <div className="Inner__upperPart text-center h-full gap-2 flex flex-col items-start justify-between">
              <a href="">+96176969094</a>
              <a href="">+9613969094</a>
            </div>
          </div>
          <div className='upperPart text-left Inner__upperPart--last flex flex-col items-center justify-between basis-1/3'>
            <p className=''>
        ...
        <div className="lowerBox flex items-center justify-between">
          <p className='text-[#66737e] basis-[20vw]'>© Website designed and developed by InnoAlchemy</p>
          ...
          <p className='text-[#66737e] basis-[20vw] text-right text-wrap'>© 2020. All Rights Reserved</p>
        </div>
        {/* end of lower box */}
      </div>
      {/*  ---------- End of Content ----------  */}
